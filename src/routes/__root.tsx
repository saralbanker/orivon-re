  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Orivon — Award-winning digital design studio" },
      {
        name: "description",
        content:
          "Orivon: Kinetic Canvas is a dynamic portfolio website showcasing creative work with advanced animations and interactive elements.",
      },
      {
        property: "og:description",
        content:
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a3a33600-661d-40ec-b8c3-afb687662bbd/id-preview-80f2f761--a47dd648-0387-4ca1-bf41-19a305e8571a.lovable.app-1776691508902.png",
      },
      {
        name: "twitter:image",
        content:
