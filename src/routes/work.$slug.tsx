...
const brandColors: Record<string, { bg: string; text: string; details: string }> = {
  ...
  "noctis-music": { bg: "bg-[var(--brand-lavender)]", text: "text-black", details: "NOCTIS RECORDS" },
  ...
  "atelier-fashion": { bg: "bg-[var(--brand-teal)]", text: "text-white", details: "ATELIER FASHION" },
  "halo-health": { bg: "bg-[var(--brand-coral)]", text: "text-white", details: "HALO HEALTH" },
};

const brandCovers: Record<string, string> = {
  "lumen-finance": "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80",
  "noctis-music": "https://images.unsplash.com/photo-1539635278303-d4002c07eae3?auto=format&fit=crop&w=1200&q=80",
  "orbit-aerospace": "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1200&q=80",
  "verdant-eco": "https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?auto=format&fit=crop&w=1200&q=80",
  "atelier-fashion": "https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=1200&q=80",
  "halo-health": "https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&w=1200&q=80",
};
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
         ...
         >
           ...
           <h1 className="font-display text-5xl md:text-8xl font-bold leading-[0.9] tracking-tight">{p.title}</h1>
           <p className="mt-8 max-w-2xl text-lg text-muted-foreground leading-relaxed">{p.description}</p>
         </motion.div>
         ...
         >
           ...
           <div className="relative z-10">
             <span className="text-xs font-mono opacity-80 uppercase tracking-widest block mb-4">CASE STUDY COVER // {colors.details}</span>
         ...
         <div className="mt-24 grid md:grid-cols-2 gap-12 items-start">
           ...
           <p className="text-lg text-muted-foreground leading-relaxed">
             ...
             world-class flagship site that would set the new bar in {p.category.toLowerCase()} without relying on stock frameworks.
           </p>
         </div>
         ...
         <div className="mt-16 grid md:grid-cols-2 gap-6">
           ...
           >
             <div>
               <span className="text-[10px] font-mono text-[var(--brand-pink)] uppercase tracking-wider block mb-4">Mockup 01 // Typography System</span>
               <h4 className="font-display text-2xl font-bold mb-3">Modular Typography Scale</h4>
               <p className="text-xs text-muted-foreground leading-relaxed">
                 A customized layout scale combining bold headings with clear, reading-optimized body copy to maximize conversion and engagement.
               </p>
             </div>
           ...
           >
             <div>
               <span className="text-[10px] font-mono text-[var(--brand-pink)] uppercase tracking-wider block mb-4">Mockup 02 // Interface Grid</span>
               <h4 className="font-display text-2xl font-bold mb-3">Fluid Interface Layout</h4>
               <p className="text-xs text-muted-foreground leading-relaxed">
                 Responsive layouts optimized for touch and desktop. Generous spacing allows components to breathe, highlighting key callouts.
               </p>
             </div>
        ...
        <div className="mt-32">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {others.map((o) => {
              const otherColors = brandColors[o.slug] || { bg: "bg-[var(--brand-pink)]", text: "text-white" };
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <h4 className="font-display text-3xl font-bold tracking-tight mb-2 group-hover:underline">{o.title.split(" — ")[0]}</h4>
...
function Meta({ label, value }: { label: string; value: string }) {
  return (
    <div className="border-t border-border pt-4">
      <div className="text-xs uppercase tracking-widest text-muted-foreground mb-2 font-mono">{label}</div>
